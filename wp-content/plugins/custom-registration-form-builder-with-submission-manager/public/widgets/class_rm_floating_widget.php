        ...
        public function show_widget() {
            ...
            <div class="rm-magic-popup">
                <div class="rm-popup-menu rm-border rm-white-box dbfl" id="rm-menu" style="display:none">
                    ...
                    <div class="rm-popup-item rm-popup-welcome-box dbfl rm-border" id="rm-account-open">
                        ...
                        <div class="rm-menu-user-details difl">
                            ...
                            <?php if(!empty($this->user->first_name) &&  !empty($this->user->last_name)): ?>
                                ...
                                <?php else: ?>
                                    <div class="dbfl"> </span> <?php echo esc_html($this->user->display_name); ?></div>
                                 <?php endif; ?>
                        </div>
                    </div>
                     <?php
                    ...
                    ?>
                    <a href="#form_<?php echo esc_attr($this->param->default_form); ?>_1" id="rm_fab_register_redirect_link"><div class="rm-popup-item dbfl" id="rm-register-open-big"><?php echo RM_UI_Strings::get('LABEL_REGISTER'); ?></div></a>
                     <?php    
                    }
...
?>
        ...
        public function include_scripts() {
            ...
            <pre class="rm-pre-wrapper-for-script-tags"><?php wp_enqueue_script('rm-color', RM_BASE_URL.'admin/js/jscolor.min.js', array(), $this->version, false); ?></pre>
            <pre class="rm-pre-wrapper-for-script-tags"><?php if(defined('REGMAGIC_ADDON')) wp_enqueue_script('rm_floating_button_js', RM_ADDON_BASE_URL.'public/js/floating-button.js', array(), $this->version, false); else wp_enqueue_script('rm_floating_button_js', RM_BASE_URL.'public/js/floating-button.js', array(), $this->version, false); ?></pre>
            <!--/noptimize-->
            <?php
        }
