    ...
    <div class="operationsbar">
        ...
        <div class="nav">
            ...
            foreach ($extended_tab_listings as $tab) {
                ?>
                <div class="rmtabs_head" title="<?php echo esc_attr($tab['label']) ?>" data-rmt-tabcontent="#<?php echo esc_attr($tab['id']) ?>"><?php echo wp_kses_post($tab['icon']) . ' ' . esc_html($tab['label']) ?></div>
                <?php
            }
                        ...
                        <div class="rm-user-card">
                            ...
                            <div class="rm-user-name-submission">
                                <div class="rm-user-name dbfl">
                                    <span data-rm_apply_acc_color='true'><?php echo RM_UI_Strings::get('LABEL_WELCOME'); ?>, </span> <?php echo esc_html($data->user->display_name); ?>
                                </div>
                                <div class="rm-user-name-subtitle dbfl">
                                    <span data-rm_apply_acc_color='true'><?php echo esc_html($data->total_submission_count); ?> </span> <?php echo RM_UI_Strings::get('LABEL_REGISTRATIONS'); ?>.
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        if (isset($meta['rm_field_type']) && $meta['rm_field_type'] == 'File') {
                                            ...
                                            foreach ($meta as $sub) {
                                                ...
                                                <div class="rm-user-attachment">
                                                    ...
                                                    <div class="rm-user-attachment-field"><a href="<?php echo esc_attr($att_url); ?>"><?php echo RM_UI_Strings::get('LABEL_DOWNLOAD'); ?></a></div>
                                                </div>
            ...
            <table class="rm-user-data">
                ...
                if ($data->submissions):
                    foreach ($data->submissions as $data_single):
                        ...
                        ?>  
                        <tr>
                            <td id="<?php echo esc_attr($data_single->submission_id); ?>"><?php echo esc_html(++$i); ?></td>
            ...
            if ($data->total_pages_sub > 1):
                ...
                <ul class="rmpagination">
                    ...
                    if ($data->curr_page_sub > 1):
                        ...
                        <li onclick="get_tab_and_redirect('rm_reqpage_sub=<?php echo esc_html($data->curr_page_sub - 1); ?>')"><a><?php echo RM_UI_Strings::get('LABEL_PREVIOUS'); ?></a></li>
                        <?php
                    endif;
                    ...
                    if ($data->curr_page_sub < $data->total_pages_sub):
                        ?>
                        <li onclick="get_tab_and_redirect('rm_reqpage_sub=<?php echo esc_html($data->curr_page_sub + 1); ?>')"><a><?php echo RM_UI_Strings::get('LABEL_NEXT'); ?></a></li>
                        <li onclick="get_tab_and_redirect('rm_reqpage_sub=<?php echo esc_html($data->total_pages_sub); ?>')"><a><?php echo RM_UI_Strings::get('LABEL_LAST'); ?></a></li>
                        <?php
                    endif;
                    ?>
                </ul>
            ...
            if ($data->total_pages_pay > 1):
                ...
                <ul class="rmpagination">
                    ...
                    if ($data->curr_page_pay > 1):
                        ...
                        <li onclick="get_tab_and_redirect('rm_reqpage_pay=<?php echo esc_html($data->curr_page_pay - 1); ?>')"><a><?php echo RM_UI_Strings::get('LABEL_PREVIOUS'); ?></a></li>
                        <?php
                    endif;
