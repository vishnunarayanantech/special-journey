...
<div class="rm-logged-in-view">
    <div class="rm-logged-in-view-wrap">
        ...
        <div class="rm_display_only_logout"><a href="<?php echo wp_logout_url(); ?>"><?php echo empty($view_options['logout_text']) ? RM_UI_Strings::get('LABEL_LOG_OFF') : wp_kses_post($view_options['logout_text']); ?></a></div>
        <?php endif; ?> 
        <?php else: ?>
        ...
        <div class="rm-logged-in-account-links" style="border-color: #<?php echo esc_html($view_options['separator_bar_color']); ?>">
            ...
            <!-- Logout -->  
            <?php if(!empty($view_options['display_logout_link'])): ?>
            <div class="rm_display_logout"><a href="<?php echo wp_logout_url(); ?>"><?php echo empty($view_options['logout_text']) ? RM_UI_Strings::get('LABEL_LOG_OFF') : wp_kses_post($view_options['logout_text']); ?></a></div>
            <?php endif; ?>    
        </div>
        <?php endif; ?>
    </div>  
