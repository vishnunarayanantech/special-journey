...
<div class="rmrow rmlms-action-call"><?php _e( 'Ready to <strong>extend</strong> power of your forms?', 'custom-registration-form-builder-with-submission-manager' ) ?></div>
    ...
    <div class="rmlms-button-wrap rmrow"><a class="button" href="<?php echo esc_url($data->lm_install_url); ?>" target="_self"><?php _e( 'Install Now', 'custom-registration-form-builder-with-submission-manager' ) ?></a></div>
    <?php else:?>
    <div class="rmlms-button-wrap rmrow"><a class="button" href="<?php echo esc_url($data->lm_activate_url); ?>" target="_self"><?php _e( 'Activate Now', 'custom-registration-form-builder-with-submission-manager' ) ?></a></div>
    <?php endif; ?>
<?php else: ?>
    <div class="rmrow">
    <?php printf(__( 'LeadMagic is already installed. <a href="%s">Click here</a> to create/manage landing pages.', 'custom-registration-form-builder-with-submission-manager' ),esc_url($data->lm_page_url)); ?>    
