...
<!--            <a href="?page=rm_options_payment"><img alt="" src="<?php //echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/rm-payments.png'; ?>"></a>-->
        ...
        <div class="nav">
            <ul class="rm-automation">
                ...
                <li><a href="?page=rm_ex_chronos_edit_task&rm_form_id=<?php echo esc_html($data->form_id); ?>"><?php echo RM_Chronos_UI_Strings::get('LABEL_NEW_TASK');?></a></li>
                ...
                <li id="<?php echo esc_attr($task_data->task_id) ?>">
                    <div class="rm-slab">
                        ...
                        <div class="rm-slab-buttons">                            
                            <a href="javascript:void(0)" id="id_rmc_run_task_now_<?php echo esc_attr($task_data->task_id); ?>" onclick="rmc_run_task_now(<?php echo esc_attr($task_data->task_id); ?>)"><?php echo RM_Chronos_UI_Strings::get("LABEL_RUN_NOW"); ?></a>
