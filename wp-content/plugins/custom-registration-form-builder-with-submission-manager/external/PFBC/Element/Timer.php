...
class Element_Timer extends Element implements Widget
{
    ...
    {
        ?>
        <div id="<?php echo esc_attr($this->_attributes["id"]); ?>" class="rm_clock <?php echo esc_attr($this->_attributes["class"]) ? '' . esc_attr($this->_attributes["class"]) : null; ?>" style="margin:2em;"></div>
        <?php
    }
