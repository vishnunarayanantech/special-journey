...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211214_theshoppie_4e6060731d5153b47043_20211214045407_archive.zip';
	const ARCHIVE_SIZE		 = '56682634';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '4e60607-14045407';
    const SECONDARY_PACKAGE_HASH = 'a8a837b-14045407';
	const VERSION			 = '1.4.3';
